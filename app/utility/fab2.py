...
class File_Table_Management:
    ...
    async def get_file_system_client(self, client_id, client_secret, tenant_id, workspace_name) -> FileSystemClient:
    ...
    async def write_json_to_file(self, directory_client: DataLakeDirectoryClient, file_name: str, json_data: dict):
        ...
        await file_client.upload_data(json_bytes, overwrite=True)
