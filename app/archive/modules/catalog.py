...
##################### INTIALIZE THE CONFIGURATION #####################
    ...
    if "ERROR" not in result:
        ...
        print(f"Workspaces: {workspaces} - and the length is {len(workspaces)}")
    else:
    ...
    # TODO: It is at this point that one needs to take the number of workspaces that were modified and 
    # and put them into bins of 500 each with a maximum call of 16         
